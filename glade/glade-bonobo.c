...
static GladeWidgetBuildData widget_data[] = {
	{ "BonoboWidget", glade_bonobo_widget_new,
	  NULL, bonobo_widget_get_type },
	{ "BonoboWindow", glade_standard_build_widget,
	  glade_standard_build_children, bonobo_window_get_type },
	{ NULL, NULL, NULL, 0, 0 }
};
